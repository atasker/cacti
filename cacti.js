function changeContent() {
  ...
  var platformViews = { text: "Platform views (past 24 hours)", image: "<img id='graph' src='http://cacti.playrific.com/graph_image.php?local_graph_id=106&rra_id=2&graph_width=1500&graph_height=200&graph_nolegend='>"};
